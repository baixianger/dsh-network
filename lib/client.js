    ...
    function AppBanner() {
      ...
      return h("aside", {
        ...
        h("div", { style: { flex: 1, minWidth: 0 } },
          ...
          h("span", { style: { display: "block", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", fontSize: 12, lineHeight: "17px", color: error ? "#b42318" : "var(--dsw-alias-label-secondary, #666b74)" } }, error || (mode === "download" ? "Continue your sessions from iPhone or iPad" : "Continue on this Server in the app"))
        ),
